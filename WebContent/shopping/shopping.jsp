		...
		<form action="order_save.action" method="post" onsubmit="return checkForm()">
			<table id="myTableProduct">
				...
				<c:forEach items="${shoppingCart.shoppingCartItems }" var="shoppingCartItem">
					<tr class="productTr">
						<td class="thumb">
							<img class="imgs" src="${shoppingCartItem.product.proPic }" /><a style="font-size: 18px; color: #444444;" href="product_showProduct.action?productId=${shoppingCartItem.product.id }" target="_blank">${shoppingCartItem.product.name }</a>
						</td>
						...
						<td class="delete"><a  style="font-size: 18px; color:#444444;"
...
<div style="margin-top: 10px;font-size: 20px;height: 40px;text-align: center">
