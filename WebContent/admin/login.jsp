...
<div id="logo"><a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/images/logo.jpg" /></a></div>
</div>
<div id="childNav">
			...
			<form id="loginForm" method="post" action="${pageContext.request.contextPath}/user_login.action" onsubmit="return checkForm()">
				<table>
					<tr>
						...
						<td><input class="text" type="text" id="userName" name="user.userName"  value="${user.userName }" /></td>
					</tr>
					<tr>
						<td class="field">登录密码：</td>
						<td><input class="text" type="password" id="password" name="user.password"  value="${user.password }" /></td>
					</tr>
					<tr>
...
<div id="footer">
	Copyright &copy; 2015 BuFanXiang All Rights Reserved.<br>
			<a href="http://weibo.com/533511456/home" target="_blank">http://weibo.com/533511456/home</a>
</div>
</body>
</html>