...
<script type="text/javascript">
	...
	//打开编辑商品大类信息对话框
	function openProductBibTypeModifyDialog(){
	...
	function deleteProductBigType(){
		...
		$.messager.confirm("系统提示：", "您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？", function(r){
			if(r){
				$.post("productBigType_delete.action", {ids:ids}, 
					function(result){
						var result = eval('('+result+')');
						if(result.success){
							if(result.exist){
	...
	function closeProductBigTyperDialog(){
		$("#dlg").dialog("close");
		resetValue();//重置表单的操作 
	}
...
<body style="margin: 1px">
	<table id="dg" title="商品大类管理" class="easyui-datagrid" 
	 ...
	 url="productBigType_list.action" fit="true" toolbar="#tb">
	  ...
	  <div id="tb">
	 	<div>
	 		...
	 		<a href="javascript:openProductBibTypeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
	 ...
	 <div id="dlg-buttons">
	 	...
	 	<a href="javascript:closeProductBigTyperDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	 </div>
</body>
</html>