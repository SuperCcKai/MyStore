...
<script type="text/javascript">
		...
		$("#fm").form("submit",{
			...
			onSubmit:function(){
				...
				if(newPassword != newPassword2){
					$.messager.alert("系统提示", "确认密码与新密码不相同！");
					return false;
				}
				return true;
			},
	...
	function logout(){
		$.messager.confirm("系统提示：", "您确定要退出管理系统吗？", function(r){
			if(r){
	...
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px">
				<font color="red" size="10">欢迎使用传媒书店后台管理系统</font>
			</div>
			<div align="center">
				<img src="${pageContext.request.contextPath}/image/demo/slider/1.png" alt="slider1" class="img-responsive">
			</div>
		</div>
	</div>
</div>
...
<div region="south" style="height: 25px; padding: 5px" align="center">
	Copyright &copy; Copyright(C) 传媒书店 2000-2017 版权所有 | 客服热线：xxx-xxx-xxxx
</div>
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 220px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
 	<form id="fm" method="post">
 		<table cellspacing="8px">
 			<tr>
 				<td>用户名：</td>
 				<td><input type="text" id="userName" name="user.userName" readonly="readonly" value="${currentUser.userName }" style="width: 200px;"/></td>
 			</tr>
 			<tr>
 				<td>原密码：</td>
