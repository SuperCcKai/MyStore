...
<div class="help">
	<c:choose>
		<c:when test="${not empty currentUser }">
			<a href="shopping_shoppingCartList.action" class="shopping">购物车(${shoppingCart.shoppingCartItems==null?0:shoppingCart.shoppingCartItems.size() }件商品)</a>
			<a href="user_userCenter.action">${currentUser.userName }</a>
			<a href="javascript:logout()">注销</a>
			<a href="register.jsp">注册</a>
			<a href="comment_showComment.action">留言</a>	
		</c:when>
		<c:otherwise>
...
<div class="navbar" style="margin-top: 50px; padding-left: 0px;">
	<ul class="clearfix">
		<li class="current" style="margin-left: 0px;"><a href="index.jsp">首页</a>
		</li>
